...
//joke api url https://v2.jokeapi.dev/joke/Any?blacklistFlags=religious,racist,sexist
...
function tellMe(joke) {
  VoiceRSS.speech({
    key: '437bd2baaae54ca98e6a45e7f5980cc9',
    src: joke,
    hl: 'en-us',
    v: 'Linda',
    r: 0, 
...
async function getJokes() {
  apiUrl = 'https://v2.jokeapi.dev/joke/Any?blacklistFlags=religious,racist,sexist'
  let joke = '';
  try{
